...
SFP.config.define('twin.layout', {
  ...
  zones: [
    ...
    { id: 'assembly-a', label: 'Assembly Line A',
      ...
      /* Demo: a simple generated SVG floorplan background (stretch fit).
       * Keep this under 2 KB. Replace with a real floorplan SVG/PNG via the
       * editor "Set image…" button, or export this config and commit your own. */
      image: {
